...
import { AlertCircle, Check, CheckCheck, Bot, Sparkles } from 'lucide-react';
...
export function MessageBubble({ message, isOwn }: MessageBubbleProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        'flex flex-col max-w-[280px] sm:max-w-[320px] lg:max-w-[400px]',
        ...
        <div
          className={cn(
            'relative rounded-2xl px-3 py-2 shadow-sm max-w-full break-words transition-all duration-200',
            isOwnMessage
        ...
        >
          ...
          <div className={cn(
            ...
            isAI ? 'text-primary/70' : 'text-muted-foreground'
          )}>
